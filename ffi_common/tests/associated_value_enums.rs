...
fn test_associated_numeric() {
    unsafe {
        ...
        assert_eq!(
            numeric_data_ffi::get_numeric_data_data(polymorphic_data),
            42
        );
...
fn test_associated_string() {
    ...
    unsafe {
        ...
        let string_data =
            string_data_ffi::string_data_rust_ffi_init(ffi_string!(test_string)) as *mut StringData;
...
fn test_struct_containing_associated_string() {
    ...
    unsafe {
        ...
        let contains_enum =
            contains_enum_ffi::contains_enum_rust_ffi_init(polymorphic as *mut HasData);
        ...
        let polymorphic_data =
            has_data_ffi::get_has_data_string_data_unnamed_field_0(polymorphic_from_struct);
