...
//! 1. TODO (next): Generating a native interface in one of the supported languages. This will wrap
//! the C headers generated by the previous step in native types for the specified language.
//!   * Will require extensive tests to ensure that the interface is wrapped correctly here.
//!
...
//! (de)serialization as a lingua franca, but this requires implementing any necessary types and
